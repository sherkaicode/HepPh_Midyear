...
# Analysis object: /ATLAS_2017_I1495243/d01-x01-y01
...
ax_xLabel = r'Number of additional jets'
ax_yLabel = r'$\frac{1}{\sigma} \frac{\mathrm{d}\sigma}{\mathrm{d}N_\mathrm{jet}}$'
ax_title  = r'Additional jet $p_\mathrm{T} > 25$ GeV'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.5, 5.5)
