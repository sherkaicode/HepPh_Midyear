...
# Analysis object: /ATLAS_2017_I1495243/d07-x01-y01
...
ax_xLabel = r'Leading additional jet $p_\mathrm{T}$ [GeV]'
ax_yLabel = r'$\frac{1}{\sigma} \frac{\mathrm{d}\sigma}{\mathrm{d}p^\mathrm{jet}_\mathrm{T}}$ [GeV$^{-1}$]'
ax_title  = r''
ax_xScale = 'log'
ax_yScale = 'log'
xLims = (25.0, 1000.0)
