...
# Analysis object: /ATLAS_2017_I1495243/d23-x01-y01
...
ax_xLabel = r'$Q_\mathrm{sum}$ [GeV]'
ax_yLabel = r'$f_\mathrm{gap}^\mathrm{part}$'
ax_title  = r'$m_{e\mu bb} > 600$ GeV, veto region: $|y| < 2.1$'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (25.0, 510.0)
yLims = (0.0, 1.1)
