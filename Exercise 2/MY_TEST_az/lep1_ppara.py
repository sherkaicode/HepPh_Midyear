...
# Analysis object: /MY_TEST/lep1_ppara
...
exec(open(prefix+'lep1_ppara__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'lep1_ppara.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'lep1_ppara.png'), format='PNG')
