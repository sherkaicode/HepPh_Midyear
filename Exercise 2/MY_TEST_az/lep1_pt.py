...
# Analysis object: /MY_TEST/lep1_pt
...
exec(open(prefix+'lep1_pt__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'lep1_pt.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'lep1_pt.png'), format='PNG')
