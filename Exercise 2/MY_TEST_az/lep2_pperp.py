...
# Analysis object: /MY_TEST/lep2_pperp
...
exec(open(prefix+'lep2_pperp__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'lep2_pperp.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'lep2_pperp.png'), format='PNG')
