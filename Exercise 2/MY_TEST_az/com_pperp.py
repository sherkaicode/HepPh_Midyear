...
# Analysis object: /MY_TEST/com_pperp
...
exec(open(prefix+'com_pperp__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'com_pperp.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'com_pperp.png'), format='PNG')
