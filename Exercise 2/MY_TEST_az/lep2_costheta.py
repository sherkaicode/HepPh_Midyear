...
# Analysis object: /MY_TEST/lep2_costheta
...
exec(open(prefix+'lep2_costheta__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'lep2_costheta.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'lep2_costheta.png'), format='PNG')
