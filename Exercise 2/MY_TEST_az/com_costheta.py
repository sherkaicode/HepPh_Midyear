...
# Analysis object: /MY_TEST/com_costheta
...
exec(open(prefix+'com_costheta__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'com_costheta.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'com_costheta.png'), format='PNG')
