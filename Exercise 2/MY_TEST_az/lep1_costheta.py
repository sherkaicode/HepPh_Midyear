...
# Analysis object: /MY_TEST/lep1_costheta
...
exec(open(prefix+'lep1_costheta__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'lep1_costheta.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'lep1_costheta.png'), format='PNG')
