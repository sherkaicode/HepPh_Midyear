...
# Analysis object: /MY_TEST/com_ppara
...
exec(open(prefix+'com_ppara__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'com_ppara.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'com_ppara.png'), format='PNG')
