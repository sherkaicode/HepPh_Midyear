...
# Analysis object: /MY_TEST/com_ppara_l1
...
exec(open(prefix+'com_ppara_l1__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'com_ppara_l1.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'com_ppara_l1.png'), format='PNG')
