...
# Analysis object: /MY_TEST/lep2_ppara
...
exec(open(prefix+'lep2_ppara__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'lep2_ppara.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'lep2_ppara.png'), format='PNG')
