...
# Analysis object: /MY_TEST/com_ppara_l2
...
exec(open(prefix+'com_ppara_l2__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'com_ppara_l2.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'com_ppara_l2.png'), format='PNG')
