...
# Analysis object: /MY_TEST/lep1_pperp
...
exec(open(prefix+'lep1_pperp__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'lep1_pperp.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'lep1_pperp.png'), format='PNG')
