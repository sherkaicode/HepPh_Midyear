...
# Analysis object: /MY_TEST/lep2_pt
...
exec(open(prefix+'lep2_pt__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'lep2_pt.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'lep2_pt.png'), format='PNG')
