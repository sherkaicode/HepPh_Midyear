...
# Analysis object: /MY_TEST/ee_mass
...
exec(open(prefix+'ee_mass__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'ee_mass.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'ee_mass.png'), format='PNG')
